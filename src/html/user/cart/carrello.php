                ...
                <div class="cart">
                  ...
                  <div class="row cart-item">
                    <div class="col-sm-2 item-detail">
                      ...
                      <p class="card-title">Frutti di porco</p>
                    </div>
                    ...
                    <div class="col-sm-2 item-detail">
                      <p>crudo, fontina, maionese, cetrioli, lamponi</p>
                    </div>
                    ...
                    <div class="col-sm-2 item-detail">
                      <div class="form-group">
                        <label class="hidden" for="imp">Impasto:</label>
                        <select class="selectpicker" id="imp">
                          <option>farro</option>
                          <option selected="selected">classico</option>

				...
				while ($row = $result->fetch_assoc()) {	
					$output .= '
						<div class="row order">
							...
							<div class="col-sm-2 apertura_mattina"><input required type="time" class="form-control" id="apertura_mattina_'.$row["giorno"].'" value="'.$row["apertura_mattina"].'"/></div>
							<div class="col-sm-2 chiusura_mattina"><input required type="time" class="form-control" id="chiusura_mattina_'.$row["giorno"].'" value="'.$row["chiusura_mattina"].'"/></div>
							<div class="col-sm-2 apertura_pomeriggio"><input required type="time" class="form-control" id="apertura_pomeriggio_'.$row["giorno"].'" value="'.$row["apertura_pomeriggio"].'"/></div>
							<div class="col-sm-2 chiusura_pomeriggio"><input required type="time" class="form-control" id="chiusura_pomeriggio_'.$row["giorno"].'" value="'.$row["chiusura_pomeriggio"].'"/></div>

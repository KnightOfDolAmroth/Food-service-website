<?php
	if(isset($_REQUEST["username"])) {
		...
		$output .= '
			...
			<div class="ord-body">
				<div class="row order">
					<div class="col-sm-2 oggetto"><input required type="text" class="form-control" id="oggetto" value="" /></div>
					<div class="col-sm-8 testo"><input required type="text" class="form-control" id="testo" value="" /></div>
